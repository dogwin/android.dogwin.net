...
public class YcMusicAdapter extends BaseAdapter {
	// 用来获得ContentProvider(共享数据库)
	public ContentResolver cr;
	// 用来装查询到的音乐文件数据
	public Cursor cur;
	// 歌曲信息列表
	public List<YcMusicInfo> musicList;
	// 歌曲详细信息属性类
	public YcMusicInfo mInfo;
	...
	public YcMusicAdapter(Context context) {
		...
		musicList = new ArrayList<YcMusicInfo>();
